...
REF_EXCEL_ORIGIN_PATH = "/../reference_files/0-2 ICU_FS_Vehicle_IO_4.2_190621_CN7_N___2020-12-30_최종.xlsm"
REF_EXCEL_NEW_PATH = "/../reference_files/0-2_ICU_Vehicle_Function_Specification_61th_201130.xlsm-CN7 N (경신검토_201230)_복호화.xlsm"
...
print(filename)
sheet = xlWb.Sheets(SEL_SHEET)

data = sheet.Range(START_CELL+":"+END_CELL).Value
data = listit(data)
# sel_car = sheet.Range(coordinate_from_string(START_CELL)).Value
print(sheet.Range(END_CELL).Address)
#data = list(data)
